...
from hackathonSystem.models import Challenge,CustomUser,RequestsMade,Team,User
...
def create_challenge(name, points, description):
...
if __name__ == "__main__":
    ...
    for i in range(5):
        create_challenge(f'challenge-{i+1}', random.randint(1,11)*10, f'description-{i+1}')
